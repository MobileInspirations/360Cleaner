...
function UploadModal({ open, onClose, onUploadComplete }: UploadModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative">
        ...
        <h2 className="text-xl font-bold mb-2">Upload Customer Data</h2>
        <p className="mb-4 text-sm text-muted-foreground">Upload a CSV file or ZIP file containing customer contacts.</p>
        <div className="mb-4">
          <input type="file" accept=".csv,.zip" onChange={handleFileChange} className="mb-2" />
