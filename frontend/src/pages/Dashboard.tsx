...
const summaryCards = [
  { label: 'Total Contacts', value: '9,024', description: 'All contacts in database' },
  { label: 'Unique Categorized', value: '100', description: 'Unique contacts in buckets' },
  { label: 'Categories', value: '14', description: '' },
  { label: 'Selected', value: '0', description: '' },
  { label: 'Export Files', value: '0', description: '(max 25k per file)' },
]

const mainBuckets = [
  { label: 'Business Operations', description: 'Business-focused contacts and operations', count: 9024, color: 'blue' },
    ...
    <div className="min-h-screen bg-background px-8 py-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
        ...
        <div className="flex flex-wrap gap-2">
          <button className="bg-primary text-primary-foreground px-4 py-2 rounded flex items-center gap-2"><span>⬆️</span> Upload CSV</button>
